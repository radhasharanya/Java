...
<jsp:setProperty property="id" name="owner" value='<%= request.getParameter("id")%>'/>
<jsp:setProperty property="first_name" name="owner" value='<%= request.getParameter("first_name")%>'/>
		<jsp:setProperty property="last_name" name="owner" value='<%= request.getParameter("last_name")%>'/>
		<jsp:setProperty property="address" name="owner" value='<%= request.getParameter("address")%>'/>
		<jsp:setProperty property="city" name="owner" value='<%= request.getParameter("city")%>'/>
		<jsp:setProperty property="telephone" name="owner" value='<%= request.getParameter("telephone")%>'/>
